...
let sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Monovan Ventas, tu seras Monkey Bot 🐈`;
...
try {
const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Monovan Ventas, tu seras Monkey Bot 🐈`

...
// Cuentas
const response = await fetch('https://raw.githubusercontent.com/MonovanShop/Monkey-Bot-Pro-/main/official_accounts.json')  
...
var canalesInfo = [
{ link: canal1, id: "120363160031023229@newsletter", name: "𝐘𝐈𝐑𝐎 𝐁𝐎𝐓 𝐁𝐘 𝐘𝐈𝐑𝐎 𝐒𝐇𝐈𝐒𝐇𝐈𝐆𝐀𝐍𝐆 💫" },
{ link: canal2, id: "120363169294281316@newsletter", name: "𝐘𝐈𝐑𝐎 𝐁𝐎𝐓 ✨" },
{ link: canal3, id: "120363203805910750@newsletter", name: "𝐘𝐈𝐑𝐎 𝐁𝐎𝐓🤩" } 
]
...
const estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: 'MonkeyBot', orderTitle: 'Bang', thumbnail: gataMenu, sellerJid: '0@s.whatsapp.net' }}}
...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: 'MonkeyBot', thumbnailUrl: gataMenu, sourceUrl: accountsgb }}}
